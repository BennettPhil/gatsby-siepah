...
const Nav = () => {
  ...
  return (
    <>
      <nav className="relative max-w-screen-xl mx-auto flex items-center justify-between px-4 sm:px-6">
        <div className="flex items-center flex-1">
          <div className="flex items-center justify-between w-full md:w-auto">
            ...
            <div className="-mr-2 flex items-center md:hidden">
              <button type="button"
                      className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 z-20 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out"
        ...
        <div className="hidden md:block text-right">
          <div className="flex md:order-2">
            <a href="https://www.instagram.com/softwareiseasypeoplearehard/" className="ml-6 text-gray-500 hover:text-red-500">
            ...
            <a href="https://twitter.com/phil_bennett" className="ml-6 text-gray-500 hover:text-red-500">
            ...
            <a href="https://www.linkedin.com/in/phil-bennett/" className="ml-6 text-gray-500 hover:text-red-500">
              <span className="sr-only">LinkedIn</span>
              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-prefix="fab" data-icon="linkedin"
                   className="h-6 w-6" viewBox="0 0 448 512">
      ...
      <div className={isMenuOpen ? "opacity-100 scale-100 absolute top-0 inset-x-0 z-40 p-2 transition transform origin-top-right md:hidden": "opacity-0 scale-95 absolute top-0 z-10 inset-x-0 p-2 transition transform origin-top-right md:hidden"}>
